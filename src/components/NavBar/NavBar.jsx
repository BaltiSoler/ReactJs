        ...
        <>
            <nav className="navbar navbar-expand-lg navbar-dark bg-dark" >
                <div className="container ">
                    <Link to="/">
                    <img src='https://musicopolix.com/blog/wp-content/uploads/2020/10/gibson-guitars.jpg' className='image ms-3 bg-white p-1 rounded-3' alt=''></img>
                    </Link>
